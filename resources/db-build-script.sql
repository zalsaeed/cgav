...
(
    ...
    male_recipient_title_en VARCHAR(255),
    male_recipient_title_ar VARCHAR(255),
    female_recipient_title_en VARCHAR(255),
    female_recipient_title_ar VARCHAR(255),
    ...
    greeting_female_ar TEXT,
    greeting_male_en TEXT,
    greeting_male_ar TEXT,
    signatory_name_1_en VARCHAR(255),
    signatory_name_1_ar VARCHAR(255),
    signatory_position_1_en VARCHAR(255),
    signatory_position_1_ar VARCHAR(255),
    signatory_name_2_en VARCHAR(255),
    signatory_name_2_ar VARCHAR(255),
    signatory_position_2_en VARCHAR(255),
    signatory_position_2_ar VARCHAR(255),
